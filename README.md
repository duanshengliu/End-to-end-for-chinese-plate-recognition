...
### 注意：若是直接识别一张无需定位的车牌如图![](https://github.com/duanshengliu/End-to-end-for-chinese-plate-recognition/blob/master/test_pic/lic.png) 请确保图片尺寸小于等于240 * 80,否则会被认为图片中含其余区域而进行定位，反而识别效果不佳
