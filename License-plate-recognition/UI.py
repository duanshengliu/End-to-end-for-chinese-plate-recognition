...
class Window:
    ...
    def load_show_img(self):
        ...
        self.can_src.create_image(257, 257, image=self.img_Tk, anchor='center')
    ...
    def display(self):
        if self.img_src_path == None:  # 还没选择图片就进行预测
            ...
            if Lic_pred:
                ...
                self.can_src.create_image(257, 257, image=self.img_Tk, anchor='center')  # img_src_copy上绘制出了定位的车牌轮廓,将其显示在画板上
